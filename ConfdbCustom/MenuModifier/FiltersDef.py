...
def CaloCNNT4HighPU(saveTags = True, Jets = "'hltSelector8CentralJetsL1FastJet'", BaseJets = "'hltAK4CaloJetsCorrectedIDPassed'", JetTags = "'hltDeepCombinedSecondaryVertexBJetTagsCalo'", BTag = "'probb'", MinTag = 0.0,  MaxTag = 999999.0, TriggerType = 86 , MinEta = -1.0 , MaxEta = 999999.0 , MinPt = 0.0, MaxPt = 999999.0 , WorkingPoint = 0.9993, NNConfig="'models_json/Calo_T4_HPU_CNN1D.pb'"):
