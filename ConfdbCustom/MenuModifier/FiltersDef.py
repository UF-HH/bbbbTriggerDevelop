...
def CaloCNNT4_HighPU(saveTags = True, Jets = "'hltSelector8CentralJetsL1FastJet'", BaseJets = "'hltAK4CaloJetsCorrectedIDPassed'", JetTags = "'hltDeepCombinedSecondaryVertexBJetTagsCalo'", BTag = "'probb'", MinTag = 0.0,  MaxTag = 999999.0, TriggerType = 86 , MinEta = -1.0 , MaxEta = 999999.0 , MinPt = 0.0, MaxPt = 999999.0 , WorkingPoint = 0.9993, NNConfig="'models_pb/Calo_prova.pb'"):
    module = 'cms.EDFilter("CaloCNNProva",\nsaveTags = cms.bool( {} ),\nJets = cms.InputTag( {} ),\nBaseJets = cms.InputTag( {} ),\nJetTags = cms.InputTag( {},{} ),\nMinTag = cms.double( {} ),\nMaxTag = cms.double( {} ),\nTriggerType = cms.int32( {} ),\nMinEta = cms.double( {} ),\nMaxEta = cms.double( {} ),\nMinPt = cms.double( {} ),\nMaxPt = cms.double( {} ),\nWorkingPoint = cms.double({}),\nNNConfig = cms.FileInPath({})\n\n)\n'.format(saveTags, Jets, BaseJets, JetTags, BTag, MinTag,  MaxTag, TriggerType, MinEta, MaxEta, MinPt, MaxPt, WorkingPoint, NNConfig)
    return module
