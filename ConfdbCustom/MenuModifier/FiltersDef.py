...
def hltBTagBisector23Calo(saveTags = True , MinBTagBis = 0.7 , JetTags = "hltDeepCombinedSecondaryVertexBJetTagsCalo", BTag = "probb", TriggerType = 86 , Jets =  "hltSelector8CentralJetsL1FastJet" , MinTag = 0.0 , MaxTag = 999999.0 ):
