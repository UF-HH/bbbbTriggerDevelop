...
for calo in calo_names_th:
    ...
    man.Insert("process.HLT_FFNNHHwp_{} = cms.Path( process.HLTBeginSequence + process.hltL1sQuadJetC50to60IorHTT280to500IorHTT250to340QuadJet + process.HLTAK4CaloJetsSequence + process.HLTBtagDeepCSVSequenceL3 + process.{} + process.HLTEndSequence )\n").format(th, calo[0])
