python CNN1DConfigGenerator_Timing_Timing.py --menu=/online/collisions/2018/2e34/v3.6/HLT -gt=101X_dataRun2_HLT_v7 -out=myHLT_TimingData.py -pr=myHLT --data --tr 319941 --th 0p87
...
python CNN1DConfigGenerator_Timing_Timing.py --menu=/online/collisions/2018/2e34/v3.6/HLT -gt=101X_dataRun2_HLT_v7 -out=myHLT_TimingData.py -pr=myHLT --data --tr 319941 --th 0p97
...
python CNN1DConfigGenerator_Timing_Timing.py --menu=/online/collisions/2018/2e34/v3.6/HLT -gt=101X_dataRun2_HLT_v7 -out=myHLT_TimingData.py -pr=myHLT --data --tr 315188 --th 0p87
echo "[Info] Running th 0.87 menu"
nohup taskset -c 0-3 cmsRun myHLT_TimingData.py >& full.log&
wait
cmsRun harvestTiming_cff.py
...
python CNN1DConfigGenerator_Timing_Timing.py --menu=/online/collisions/2018/2e34/v3.6/HLT -gt=101X_dataRun2_HLT_v7 -out=myHLT_TimingData.py -pr=myHLT --data --tr 315188 --th 0p97
echo "[Info] Running th 0.97 menu"
nohup taskset -c 0-3 cmsRun myHLT_TimingData.py >& full.log&
wait
cmsRun harvestTiming_cff.py
