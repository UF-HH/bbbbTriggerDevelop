...
man.CreateFromLocal(in_class="CaloCNNT4_HighPU0p9993",mod_name="CaloCNNT4_HighPU")
man.InsertInMenu(in_class="CaloCNNT4_HighPU0p9993",process_name = 'in_class')
...
man.Insert("process.HLT_CaloCNNT4_HighPU0p9993 = cms.Path( process.HLTBeginSequence + process.hltL1sQuadJetC50to60IorHTT280to500IorHTT250to340QuadJet + process.hltPreCaloCNNT4HighPU0p9993 + process.HLTAK4CaloJetsSequence + process.HLTBtagDeepCSVSequenceL3 + process.CaloCNNT4_HighPU0p9993 + process.HLTEndSequence )\n")
