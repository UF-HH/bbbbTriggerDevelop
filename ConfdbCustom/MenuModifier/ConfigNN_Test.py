...
man.InsertPath("process.HLT_CaloCNNT4_HighPU0p9993_20_1 = cms.Path( process.HLTBeginSequence + process.hltL1sQuadJetC50to60IorHTT280to500IorHTT250to340QuadJet + process.hltPreCaloCNNT4HighPU0p9993201 + process.HLTAK4CaloJetsSequence + process.HLTBtagDeepCSVSequenceL3 + process.CaloCNNT4HighPU0p9993_20_1 + process.HLTEndSequence )\n")
man.InsertPath("process.HLT_CaloCNNT4_HighPU0p9993_5_4 = cms.Path( process.HLTBeginSequence + process.hltL1sQuadJetC50to60IorHTT280to500IorHTT250to340QuadJet + process.hltPreCaloCNNT4HighPU0p999354 + process.HLTAK4CaloJetsSequence + process.HLTBtagDeepCSVSequenceL3 + process.CaloCNNT4HighPU0p9993_5_4 + process.HLTEndSequence )\n")
man.InsertPath("process.HLT_CaloDNNT4_HighPU_20_0p9998 = cms.Path( process.HLTBeginSequence + process.hltL1sQuadJetC50to60IorHTT280to500IorHTT250to340QuadJet + process.hltPreCaloDNNHighPU200p9998 + process.HLTAK4CaloJetsSequence + process.HLTBtagDeepCSVSequenceL3 + process.CaloDNNHighPU_20_0p9998 + process.HLTEndSequence )\n")
