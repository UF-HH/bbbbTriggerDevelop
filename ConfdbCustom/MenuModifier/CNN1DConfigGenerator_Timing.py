...
#
# example usage MC: python CNN1DConfigGenerator_Timing.py --menu=/dev/CMSSW_11_0_0/GRun/V7 -out=myHLT.py -gt=110X_mcRun3_2021_realistic_v6 -pr=myHLT -paths=HLTriggerFirstPath,HLT_PFHT330PT30_QuadPFJet_75_60_45_40_TriplePFBTagDeepCSV_4p5_v3,HLTriggerFinalPath,HLTAnalyzerEndpath --timing --outfile 
# example usage Data: python CNN1DConfigGenerator_Timing.py --menu=/dev/CMSSW_10_1_0/GRun -gt=101X_dataRun2_HLT_v7 -out=myHLT.py -pr=myHLT -paths=HLTriggerFirstPath,HLT_PFHT330PT30_QuadPFJet_75_60_45_40_TriplePFBTagDeepCSV_4p5_v3,HLTriggerFinalPath,HLTAnalyzerEndpath --timing  --data --run 323725,323725 --ls [18,22],[37,57] --outfile SumBTagRateEstimate.root --json ../test/Json/json_2018D_Ephemeral_20181022_PU50.txt
# example usage Data online menu (no HLTAnalyzerEndPath): python CNN1DConfigGenerator_Timing.py --menu=/online/collisions/2018/2e34/v3.6/HLT -gt=101X_dataRun2_HLT_v7 -out=myHLT.py -pr=myHLT -paths=HLTriggerFirstPath,HLT_PFHT330PT30_QuadPFJet_75_60_45_40_TriplePFBTagDeepCSV_4p5_v3,HLTriggerFinalPath,HLTAnalyzerEndpath --timing  --data --run 323725,323725 --ls [18,22],[37,57] --outfile SumBTagOnlineRateEstimate.root --json ../test/Json/json_2018D_Ephemeral_20181022_PU50.txt
# example usage Data for Timing: python CNN1DConfigGenerator_Timing_Timing.py --menu=/online/collisions/2018/2e34/v3.6/HLT -gt=101X_dataRun2_HLT_v7 -out=myHLT_TimingData.py -pr=myHLT --data --tr 319941 --th 0p9
#--------------------------------------------------------------------------------------------------------------------------------
...
parser.add_argument('-th', '--th', type=str, required=False, help="Threshold for CNN1D trigger", default='0p9')
parser.add_argument('-input_dim', '--input_dim', type=str, required=False, help="(5,4) or (20,1)?", default='(5,4)')
...
if args.input_dim == '(5,4)':
    inclass_name = "CaloCNNT4HighPUInput54{}".format(args.th)
    man.CreateFromLocal(in_class=inclass_name,mod_name="CaloCNNT4HighPU_5_4", WorkingPoint=float_th)
    man.InsertInMenu(in_class=inclass_name,process_name = 'in_class')

elif args.input_dim == '(20,1)':
    inclass_name = "CaloCNNT4HighPUInput201{}".format(args.th)
...
man.InsertPrescaleModule('hltCNN', offset=0, name='strip')
