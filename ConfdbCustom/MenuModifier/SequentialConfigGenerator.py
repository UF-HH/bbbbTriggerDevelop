...
man.InsertPath("process.HLT_Quad30_Double60_Sum2LeadingBTag_1p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sQuadJetC50to60IorHTT280to500IorHTT250to340QuadJet + process.hltPrePFHT330PT30QuadPFJet75604540TriplePFBTagDeepCSV4p5 + process.HLTEndSequence )\n")
...
man.InsertPath("process.HLT_PFHT270_180_Double180_Double90_BisectorBTag07_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sQuadJetC50to60IorHTT280to500IorHTT250to340QuadJet + process.hltPrePFHT330PT30QuadPFJet75604540TriplePFBTagDeepCSV4p5 + process.HLTEndSequence )\n")
