#ifndef LSTM_20_Adytia_h
#define LSTM_20_Adytia_h
...
template <typename T>
class LSTM_20_Adytia : public HLTFilter {
public:
  explicit LSTM_20_Adytia(const edm::ParameterSet& config);
  ~LSTM_20_Adytia() override;
