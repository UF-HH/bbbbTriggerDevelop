//ATM we need to use the Event from the HLT signal because the .root has a different structure
//c++ -o prova JsonEffHLT.cpp ../../../bbbbTrg/analysis/src/Event.cc ../../../bbbbTrg/analysis/src/TriggerMaker.cc `root-config --cflags --glibs`
//./prova ../TriggerCnfg/Trig2018.txt

#include <iostream>
#include <string.h>
#include "../../../bbbbTrg/analysis/interface/TriggerMaker.h"
#include <iostream>
#include <fstream>
#include "time.h"
...
int main(int argc, char* argv[]){
    ...
    TFile* f = new TFile("../../../bbbbTrg/test/filter_tests_2018_nob.root");
    ...
    Trig2018.InsertCut("hltBTagCaloDeepCSVp17Double", "CustomFixedBtagSelector", "CaloBJets", hltBTagCaloDeepCSVp17Double, 2);
    //last btag is in last position so we just push it into the module
    Trig2018.PushCut("hltBTagPFDeepCSV4p5Triple", "CustomFixedBtagSelector", "PFBJets", hltBTagPFDeepCSV4p5Triple);
    ...
    //std::ofstream ofile;
    std::ofstream ofile("HLTEff.txt" , std::ios::app);
