//c++ -o tmp TurnOnNNmHH.cpp ../src/TriggerMaker.cc ../src/Event.cc `root-config --cflags --glibs`
#include <iostream>
#include <vector>
#include <string>
#include <algorithm>
...
int main(){
    ...
    TH1F* h_tot = new TH1F("mHHTurnOn", "mHHTurnOn", 250, 0, 1200);
    TH1F* h_cut = new TH1F("mHHTurnOn_cut", "mHHTurnOn_cut", 250, 0, 1200);
    ...
    leg->AddEntry(h_cut, "Passed HLT_FFNNHH4bwp0p87Calo");
