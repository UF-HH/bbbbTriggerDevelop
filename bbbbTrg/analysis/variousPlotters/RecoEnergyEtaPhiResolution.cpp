...
int main(){
    ...
    TH1F* h_calo_p = new TH1F("h_calo_p", "h_calo_p", 50, -0.1, 0.1);
    h_calo_p->SetMarkerStyle(24);
    h_calo_p->SetLineColor(kMagenta+1);
    h_calo_p->SetMarkerColor(kMagenta+1);

    TH1F* h_pf_p = new TH1F("h_pf_p", "h_pf_p", 50, -0.1, 0.1);
    ...
    h_pf_p->GetYaxis()->SetTitle("(1/N_{jet})dN_{jet}/ 0.004");
    h_pf_p->SetTitle("");

    TH1F* h_L1_p = new TH1F("h_L1_p", "h_L1_p", 50, -0.1, 0.1);
    h_L1_p->SetMarkerStyle(25);
    h_L1_p->SetLineColor(kBlue);
    h_L1_p->SetMarkerColor(kBlue);

    TLegend* leg_c_p = new TLegend(0.85, 0.83, 0.65, 0.6);
    ...
    TH1F* h_calo_e = new TH1F("h_calo_e", "h_calo_e", 50, -0.1, 0.1);
    h_calo_e->SetMarkerStyle(24);
    h_calo_e->SetLineColor(kMagenta+1);
    h_calo_e->SetMarkerColor(kMagenta+1);

    TH1F* h_pf_e = new TH1F("h_pf_e", "h_pf_e", 50, -0.1, 0.1);
    ...
    h_pf_e->GetYaxis()->SetTitle("(1/N_{jet})dN_{jet}/ 0.004");
    h_pf_e->SetTitle("");

    TH1F* h_L1_e = new TH1F("h_L1_e", "h_L1_e", 50, -0.1, 0.1);
    ...
    TF1*fpf = new TF1("fpf", lorentzianPeak, -0.4, 0.4, 3);
    fpf->SetParameters(0.1, 0.01, 0.01);
    fpf->SetLineColor(kBlack);
    /*
    fpf->SetParameter(0, 0.1);
    fpf->SetParameter(1, .0);
    fpf->SetParameter(2, 0.05);
    fpf->SetParameter(3, 1);
    fpf->SetParameter(4, 5);
    */
    TF1*fcalo = new TF1("fcalo", lorentzianPeak, -0.4, 0.4, 3);
    fcalo->SetParameters(0., 0.1, 0.1);
    fcalo->SetLineColor(kMagenta+1);
    /*
    fcalo->SetParameter(0, 0.1);
    fcalo->SetParameter(1, 0.);
    fcalo->SetParameter(2, 0.);
    fcalo->SetParameter(3, 0.5);
    fcalo->SetParameter(4, 10);
    */
    TF1*fl1 = new TF1("fl1", lorentzianPeak, -0.4, 0.4, 3);
    fl1->SetParameters(0., 0.1, 0.1);
    fl1->SetLineColor(kBlue);
    /*
    fl1->SetParameter(0, 0.1);
    fl1->SetParameter(1, 0.);
    fl1->SetParameter(2, 0.);
    fl1->SetParameter(3, 1);
    fl1->SetParameter(4, 10);
    */
